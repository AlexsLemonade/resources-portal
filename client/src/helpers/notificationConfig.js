export const notificationConfig = {
        ...
        "MATERIAL_REQUEST_SHARER_APPROVED": {
            "body": (
                "{you_or_other_name_upper} accepted a [request](request) for {material_category}, [material_name] from {requester_name}. Waiting for {requester_name} to provide the following information:{required_info_plain_text}"
            ),
        },
        "MATERIAL_REQUEST_SHARER_REJECTED": {
            "body": (
                "{you_or_other_name_upper} rejected a request for {material_category}, [material_name] for the below reason: {rejection_reason}"
            ),
        },
