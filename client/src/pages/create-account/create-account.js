...
const CreateAccountPage = ({ stepNum, ORCID }) => {
  ...
  return (
    <Box width={{ min: '500px', max: '800px' }}>
      ...
      <Box width={{ min: '400px', max: '700px' }}>
        ...
        {currentIndex === 0 && <CreateAccountStep ORCID={ORCID} />}
        {currentIndex === 1 && <VerifyGrantStep ORCID={ORCID} />}
        {currentIndex === 2 && <NextStepsStep ORCID={ORCID} />}
      </Box>
