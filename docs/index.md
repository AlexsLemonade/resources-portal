...
```
heroku create resources-portal-prod --remote prod && \
    heroku addons:create newrelic:wayne --app resources-portal-prod && \
    heroku addons:create heroku-postgresql:hobby-dev --app resources-portal-prod && \
    heroku config:set DJANGO_SECRET=`openssl rand -base64 32` \
        DJANGO_AWS_ACCESS_KEY_ID="Add your id" \
        DJANGO_AWS_SECRET_ACCESS_KEY="Add your key" \
        DJANGO_AWS_STORAGE_BUCKET_NAME="resources-portal-prod" \
        --app resources-portal-prod
```

Creating the qa sever:

```
heroku create `resources-portal-qa --remote qa && \
    heroku addons:create newrelic:wayne && \
    heroku addons:create heroku-postgresql:hobby-dev && \
    heroku config:set DJANGO_SECRET=`openssl rand -base64 32` \
        DJANGO_AWS_ACCESS_KEY_ID="Add your id" \
        DJANGO_AWS_SECRET_ACCESS_KEY="Add your key" \
        DJANGO_AWS_STORAGE_BUCKET_NAME="resources-portal-qa" \
```
